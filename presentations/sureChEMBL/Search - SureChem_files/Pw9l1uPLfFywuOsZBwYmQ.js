window.UserVoice = {
    ...
    account: {
        ...
        "name": "SureChem",
        "white_labeled": true,
        "subdomain_ssl_host": "surechem.uservoice.com",
        "subdomain_site_host": "surechem.uservoice.com",
        "subdomain_key": "surechem",
        "subdomain_id": 134706,
        "client_key": "ZhIOvsel6lej2GwqyNwZiQ",
        "client_options": null,
...
"undefined" != typeof UserVoice && UserVoice.showLightbox || ! function(t, e, o) {
    ...
    function r(t, e, o, i, s) {
        var r = t - e / 2;
        return o > r - s && (r = o + s), r + e + s > i && (r = i - e - s), r
    }

    function n(e) {
        if ("getComputedStyle" in t) {
            for (var i = ["transitionDuration", "MozTransitionDuration", "WebkitTransitionDuration", "OTransitionDuration", "msTransitionDuration"], s = 0, r = 0, n = i.length; n > r; r++) {
                var a = i[r],
            ...
            if (0 !== s) {
                var p = A.data(e, "transition-timer"),
                    ...
                    c = +new Date + s;
                A.addClass(e, "uv-is-transitioning"), e.offsetWidth, (p === o || c > d) && (clearTimeout(p), A.data(e, "transition-timer", setTimeout(function() {
                    A.removeClass(e, "uv-is-transitioning"), e.offsetWidth
    ...
    function p() {
        if (!Y) {
            ...
            if (t) {
                ...
                t.parentNode.removeChild(t), e.test(o) ? a(o.replace(e, "user-scalable=0")) : a(o + "; user-scalable=0")
    ...
    function d() {
        if (Y) {
            var t = l();
            t.parentNode.removeChild(t), I ? e.head.appendChild(I) : a("user-scalable=1"), Y = !1
        }
    }
    ...
    function h(t) {
        ...
        return o.innerHTML = t, e.body.insertBefore(o.firstChild, e.body.firstChild), e.body.firstChild
    }
    ...
    function k(t, e) {
        return e && ("support" === e.mode ? e.post_idea_enabled = !1 : "feedback" === e.mode && (e.contact_enabled = !1), delete e.mode, e.default_mode !== o && (e.classic_default_mode = e.default_mode), _(e)), T({
            mode: t
        }, e || {})
    }
    ...
    S.sanitizeValue = function(t, e) {
            ...
            switch (e) {
                ...
                case "timestamp":
                    ...
                    break;
                case "int":
                    o = parseInt(t, 10), isNaN(o) && (o = 0);
                    break;
                case "float":
                    o = parseFloat(t), isNaN(o) && (o = 0);
                    break;
                case "string":
                    o = t.toString();
                    break;
            ...
            var e, o, i, s, r, n, a, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                p = "",
                d = 0;
            for (t = S.uTF8Encode(t); d < t.length;) e = t.charCodeAt(d++), o = t.charCodeAt(d++), i = t.charCodeAt(d++), s = e >> 2, r = (3 & e) << 4 | o >> 4, n = (15 & o) << 2 | i >> 6, a = 63 & i, isNaN(o) ? n = a = 64 : isNaN(i) && (a = 64), p = p + l.charAt(s) + l.charAt(r) + l.charAt(n) + l.charAt(a);
            return p
        }, S.extend = function(t) {
            for (var e = Array.prototype.slice.call(arguments, 1), o = e.length, i = 0; o > i; i++)
            ...
            return i.expires && (i.expires.setFullYear(i.expires.getFullYear() + 1), s.push("; expires="), s.push(i.expires.toUTCString())), e.cookie = s.join(""), o
        }, S.getCookie = function(t) {
            for (var o, i = (e.cookie || "").split(";"), s = i.length, r = 0; s > r; r++)
                if (o = S.trim(i[r]), o.substr(0, t.length + 1) === t + "=") return decodeURIComponent(o.substr(t.length + 1))
        }, S.trim = function(t) {
        ...
        function() {
            ...
            function i(t, e) {
                var a, l, p, d, c, h = s,
                    u = e[t];
                switch (u && "object" == typeof u && "function" == typeof u.toJSON && (u = u.toJSON(t)), "function" == typeof n && (u = n.call(e, t, u)), typeof u) {
                    case "string":
                        return o(u);
                    case "number":
                    ...
                    case "object":
                        if (!u) return "null";
                        if (s += r, c = [], "[object Array]" === Object.prototype.toString.apply(u)) {
                            for (d = u.length, a = 0; d > a; a += 1) c[a] = i(a, u) || "null";
                            return p = 0 === c.length ? "[]" : s ? "[\n" + s + c.join(",\n" + s) + "\n" + h + "]" : "[" + c.join(",") + "]", s = h, p
                        }
                        if (n && "object" == typeof n)
                            for (d = n.length, a = 0; d > a; a += 1) "string" == typeof n[a] && (l = n[a], p = i(l, u), p && c.push(o(l) + (s ? ": " : ":") + p));
                        else
            ...
            var s, r, n, a = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
                l = {
                    "\b": "\\b",
                    "	": "\\t",
                    "\n": "\\n",
            ...
            "function" != typeof JSON.stringify && (JSON.stringify = function(t, e, o) {
                var a;
                if (s = "", r = "", "number" == typeof o)
                    for (a = 0; o > a; a += 1) r += " ";
                else "string" == typeof o && (r = o); if (n = e, e && "function" != typeof e && ("object" != typeof e || "number" != typeof e.length)) throw new Error("JSON.stringify");
                return i("", {
                    "": t
                })
            })
    ...
    var U = function(t, o) {
            function i(e, o) {
                var s = this;
                this.subdomain = e, this.config = S.extend({}, i.default_config, o || {}), this.babaId = a++, this.tracks = [], this.identity = null, this.uvts = null, this.isReady = !1, this.needsIdentityFlush = !1, this.needsSessionFlush = !1, this.firedUvts = !1, this.firedSession = !1, this.syncedSession = !0, this.cookieable = null, this.initFromCookie(), t.__babas.push(this)
            }

            function s(t) {
                this.props = {}, !t === Object(t) && (t = {}), this.set(S.extend({}, t, {
                    o: (new Date).getTimezoneOffset()
                }))
            }

            function r() {
                this.store = new n, this.recurrent = this.store.get("r"), this.store.set("r", !0)
            }
            ...
            var a = 0;
            t.__babas = t.__babas || [], i.prototype.initFromCookie = function() {
                var t = S.getCookie(this.config.cookie_name);
                this.log("Babayaga#initFromCookie: %s", t), t && this.setUvts(t)
            }, i.prototype.identify = function(t) {
                this.log("Babayaga#identify: %O", t), this.identity ? this.identity.set(t) : this.identity = new s(t), this.needsIdentityFlush = !0, this.flush()
                ...
                this.log("Babayaga#updateSession: %O", t), this.needsSessionFlush = S.extend({}, this.needsSessionFlush || {}), this.flush()
                ...
                this.uvts = t, S.setCookie(this.config.cookie_name, t, {
                ...
                this.log("Babayaga#trackExternalView: %s", this.config.channel), "external" === this.config.channel && this.track("view_page", {
                ...
                var o = [this.config.domain, "/t/", this.subdomain, "/", l[t.channel || this.config.channel] || "_", "/", p[t.evt] || "_"],
                    i = {},
                    s = true;
                this.uvts && (o.push("/"), o.push(this.uvts)), o.push("/track.js?_=" + (new Date).getTime()), o.push("&s=" + (s ? "0" : "1")), o = o.join(""), this.needsIdentityFlush && (i.u = this.identity.toJSON(), this.needsIdentityFlush = !1), this.needsSessionFlush === Object(this.needsSessionFlush) && (i.u = S.extend({}, i.u || {}, this.needsSessionFlush), this.needsSessionFlush = !1), t.props && S.values(t.props).length > 0 && (i.e = t.props), this.log("Babayaga#sendTrack: %s, %O", o, i), i = S.values(i).length > 0 ? encodeURIComponent(S.base64Encode(JSON.stringify(i))) : null;
                var r, n, a;
                a = ["&c="], i && (a.push("&d="), a.push(i)), r = e.getElementsByTagName("script")[0], n = e.createElement("script"), n.type = "application/javascript", n.async = !0, n.defer = !0, n.src = o + a.join(""), r.parentNode.insertBefore(n, r)
            }, i.prototype.ready = function() {
                this.log("Babayaga#ready: %s", this.isReady), this.isReady || (this.isReady = !0, this.flush(), this.afterReady())
                ...
                return null === this.cookieable && (S.setCookie("__uvt", "1", {
                    ...
                    domain: this.cookieDomain()
                })), this.log("Babayaga#haveCookies: %s", this.cookieable), this.cookieable
                ...
                var e, o = {};
                for (e in t) r.keys.hasOwnProperty(e) && (o[e] = S.sanitizeValue(t[e], r.keys[e]));
                ...
                var t, e = {};
                for (var i in r.keys) r.keys.hasOwnProperty(i) && (t = this.get(i), t !== o && (e[i] = t));
                return e
            ...
            }, n.prototype.makeKey = function(t) {
    ...
    }, F.match(/IEMobile/i) ? F.ieMobile = !0 : F.match(/msie (\d+\.\d+);/i) ? (F.ie = !0, F.version = parseInt(RegExp.$1, 10), F["ie" + F.version] = !0, F.ieCompatibility = 7 === F.version && F.match(/Trident/i), F.ieQuirks = e.compatMode && "BackCompat" === e.compatMode) : F.match(/Trident.*rv:(\d+)/i) && (F.ie = !0, F.version = parseInt(RegExp.$1, 10), F["ie" + F.version] = !0), F.touch = "ontouchstart" in t, F.mobile = F.match(/Android.*Mobile|iPhone|IEMobile/i), F.tablet = !F.mobile && F.match(/Android|iOS/i), F.iOS = "ontouchstart" in t && F.match(/like Mac OS X/i);
    var I, N = function(t) {
        ...
        A = function() {
            var o = function() {
                    ...
                    for (var s = t.getElementsByTagName(o), r = new RegExp("\b" + i + "\b", "gmi"), n = 0; n < s.length; n++)
                        if (r.test(s[n].className)) return s[n];
                    return null
                },
                i = 0;
            return o.uniqId = function() {
                ...
                function t(t, i, s) {
                    var r = o.identify(t);
                    return e[r] = e[r] || {}, arguments.length > 2 ? e[r][i] = s : e[r][i]
                }
                var e = {};
                return t
                ...
                var n = t.clientWidth,
                    a = t.clientHeight;
                return o.display = r, o.position = s, o.visibility = i, {
                    width: n,
                    height: a
                }
            }, o.offset = function(t) {
        ...
        L = function() {
            ...
            return t.prototype.push = function(t) {
                this.widget = t, this.widgets.push(t)
                ...
                var t = new Image,
                    e = this;
                A.on(t, "load", function() {
                    e.createElement(), e.show(), Q.pendingAutoprompt && (Q.pendingAutoprompt = !1, Q.autoprompt())
                }), t.src = this.options.imgSrc, f()
            }, t.prototype.createElement = function() {
                var t = this.el = h(c(this.template, this.options)),
                    e = t.getElementsByTagName("a")[0],
                    o = this;
                A.addClass(t, "uv-tab uv-slide-" + this.edge), this.dimensions = A.dimensions(t), this.hide(!1), this.rotation && (t.style.marginTop = ["-", Math.round(this.dimensions.height / 2), "px"].join("")), A.on(e, "click", function(t) {
                    return t.preventDefault && t.preventDefault(), o.visibleWidget ? o.visibleWidget.hide() : o.widget.show(), !1
                })
            }, t.prototype.remove = function() {
                this.el && (this.widget.hide(), this.hide())
            }, t.prototype.hide = function(t) {
                t = t === o ? !0 : t, t && n(this.el), A.addClass(this.el, "uv-is-hidden"), this.el.offsetWidth
            }, t.prototype.show = function() {
                n(this.el), A.removeClass(this.el, "uv-is-hidden"), this.el.offsetWidth
                ...
                var t = {
                    ...
                    e = T({}, t, this.options);
                e.trigger_position.match(/^((top|bottom|middle)-(left|right)|left|right)$/) || (e.trigger_position = t.trigger_position), e.trigger_position.match(/^(right|left)$/) && (e.trigger_position = "middle-" + e.trigger_position), "string" == typeof e.trigger_background_color && e.trigger_background_color.match(/^#/) && (e.trigger_background_color = e.trigger_background_color.substring(1));
                var o = /([^\-]+)-([^\-]+)/.exec(e.trigger_position),
                    i = o[1],
                    s = o[2],
                    r = "middle" === o[1] ? 90 : 0,
                    n = UserVoice.account.white_labeled ? "-no-bullhorn" : "",
                    a = ["tab-", e.inverted ? "light-" : "dark-", e.trigger_position].join(""),
                    l = [r ? "link-vertical" : "link-horizontal", n].join(""),
                    p = [M, "/dcache", "/widget/feedback-tab.png?t=", encodeURIComponent(e.tab_label), "&c=", e.tab_inverted ? encodeURIComponent(e.trigger_background_color) : "ffffff", "&r=", encodeURIComponent(r), e.tab_inverted ? "&i=yes" : ""].join(""),
                    d = e.trigger_position.replace(/middle-/, "").replace(/(bottom|top)-(right|left)/, "horizontal");
                d = ["tab-", d, e.tab_inverted ? "-light" : "-dark", n].join(""), d = [M, UserVoice.manifest[d]].join(""), e.bgImage = d, e.imgSrc = p, e.tab_label = u(e.tab_label), a = P[a], l = P[l], (F.ie6 || F.ieQuirks) && (a += "position:absolute !important;", "top" === i ? a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (!this.offsetHeight && 0)) + 'px');" : "middle" === i ? a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + ((((document.documentElement.clientHeight || document.body.clientHeight) + (!this.offsetHeight && 0)) / 2) >> 0)) + 'px');" : "bottom" === i && (a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (document.documentElement.clientHeight || document.body.clientHeight) - this.offsetHeight) + 'px');")), e.tabStyle = c(a, {
                    color: e.trigger_background_color,
                    bgImage: e.bgImage
                }), e.linkStyle = l, "top" === i ? this.edge = "top" : "bottom" === i ? this.edge = "bottom" : "left" === s ? this.edge = "left" : "right" === s && (this.edge = "right"), this.rotation = r, this.options = e
            }, t
        }(),
        W = function() {
            function i() {}
            return i.template = '      <div class="uv-popover-content">        <div class="uv-popover-iframe-container"></div>        <div class="uv-popover-loading"><div class="uv-popover-loading-text">' + N("loading") + '&#8230;</div></div>        <!-- shadow for ie8 -->        <div class="uv-popover-content-shadow"></div>      </div>    ', i.prototype.show = function(t) {
                t = t === o ? !0 : t, Q.hideActive(), Q.active = this, this.el || this.render(), this.trigger && (this.trigger.visibleWidget = this), this.trigger && this.trigger.popoverWillShow && this.trigger.popoverWillShow(), t ? this.animateIn() : A.removeClass(this.el, "uv-is-hidden"), this.iframe.poke({
                    show: !0
                }), this.iframe.poke({
                    focus: null
                })
                ...
                this.el || this.render(), this.visible() ? this.hide(t) : this.show(t)
            }, i.prototype.animateIn = function() {
                this.position(), n(this.el), A.removeClass(this.el, "uv-is-hidden"), this.el.offsetWidth, this.createIframe()
            }, i.prototype.preload = function() {
                this.el || this.render(), this.createIframe(!0)
            }, i.prototype.animateOut = function() {
                n(this.el), A.addClass(this.el, "uv-is-hidden")
                ...
                var t = this.visible();
                A.addClass(this.el, "uv-no-transition"), t || (A.addClass(this.el, "uv-is-invisible"), this.el.style.left = "-1000px"), A.removeClass(this.el, "uv-scale-\\S+"), this.el.offsetWidth, this.calculatePosition(), this.el.offsetWidth, t || A.removeClass(this.el, "uv-is-invisible"), A.removeClass(this.el, "uv-no-transition"), this.el.offsetWidth
                ...
                (!this.iframe || this.needsReload) && (this.iframe && (o.removeChild(this.iframe.el), this.needsReload = !1), e && (A.removeClass(this.el, "uv-is-hidden"), this.el.style.left = "-10000px", this.preloading = !0), this.iframe = new $("popover", this.options.widgetType, T({
                    height: "100%"
                }, UserVoice.globalOptions, this.options)), this.iframe.render(), A.addClass(this.iframe.el, "uv-popover-iframe"), o.appendChild(this.iframe.el), F.ie8 && A.addClass(this.el, "uv-ie8"), A.on(t, "resize", function() {
                    s.visible() && s.calculatePosition()
                }), i && i.parentNode && (this.iframe.loaded || F.ie && F.version < 10 ? i.parentNode.removeChild(i) : A.one(this.iframe.el, "load", function() {
                    s.preloading && (A.addClass(s.el, "uv-is-hidden"), s.el.style.left = "", s.preloading = !1), i.parentNode.removeChild(i)
                })))
            }, i.prototype.createElement = function(t) {
                var o = this.el = e.createElement("div");
                o.innerHTML = this.template, o.setAttribute("data-html2canvas-ignore", !0), this.options.width && !F.mobile && (A(o, "uv-popover-content").style.width = this.options.width), this.options.height && !F.mobile && (A(o, "uv-popover-content").style.height = this.options.height), A.addClass(this.el, "uv-popover uv-is-hidden"), t.appendChild(o)
            }, i
        }(),
        B = function() {
            function o(t) {
                this.template = W.template, this.options = t, f()
            }
            return o.prototype = T({}, W.prototype), o.prototype.render = function() {
                this.createElement(e.body)
            }, o.prototype.show = function() {
                var e, o, i;
                F.mobile && p(), W.prototype.show.apply(this, arguments), F.match(/iPhone OS 7/) && (e = this, i = function() {
                    e.visible() && (o !== y().height ? (t.scrollBy(0), o = y().height, setTimeout(i, 80)) : setTimeout(i, 800))
                }, i())
            }, o.prototype.hide = function() {
                W.prototype.hide.apply(this, arguments), F.mobile && (d(), this.needsReload = !0)
                ...
                if (this.el.style.zIndex = 100003, F.mobile) {
                    var i = A(this.el, "uv-popover-content"),
                        ...
                        a = s / (r + 2 * n),
                        l = Math.round(a * n);
                    i.style.width = "100%", i.style.height = "100%", this.el.style.position = "fixed", this.el.style.top = l + "px", this.el.style.left = l + "px", this.el.style.bottom = l + "px", this.el.style.right = l + "px"
                } else {
                    var n = 20;
                    this.el.style.left = "", this.el.style[o[1]] = n + "px", this.el.style[o[2]] = n + "px"
                }
                A.addClass(this.el, "uv-" + ("bottom" === o[1] ? "top" : "bottom")), A.addClass(this.el, "uv-scale-" + e)
            }, o
        }(),
        R = function() {
            function t(t, e) {
                this.template = W.template + '<div class="uv-popover-tail"></div>', this.options = t, this.trigger = e, f()
            }
            return t.prototype = T({}, W.prototype), t.prototype.render = function() {
                this.target = "self" === this.options.target ? this.trigger.el : A.element(this.options.target), Q.systemTrigger && this.target === Q.systemTrigger.el ? (this.container = this.target, this.isContained = !0) : this.container = e.body, this.createElement(this.container)
            }, t.prototype.paneOpened = function(t, e) {
                W.prototype.paneOpened.apply(this, arguments), this.setTailColor(e.backgroundColor)
                ...
                var t = this.target,
                    ...
                    r = 100;
                return "fixed" !== s && (o.top -= e.body.scrollTop, o.left -= e.body.scrollLeft), o.top < r ? "bottom" : o.top + i.height + r > y().height ? "top" : o.left < r ? "right" : o.left + i.width + r > y().width ? "left" : o.top > o.top + i.height - y().height ? "bottom" : "top"
                ...
                var t = A(this.el, "uv-popover-tail"),
                    ...
                    n = "left" === s ? "width" : "height",
                    a = "left" === s ? "top" : "left",
                    l = "width" === n ? "height" : "width",
                    p = A.dimensions(this.el),
                    d = A.dimensions(e),
                    c = A.offset(e),
                    h = r(c[s] + d[n] / 2, p[n], 0, y()[n], 10),
                    u = r(c[s] - h + d[n] / 2, A.dimensions(t)[n], 0, p[n], 15),
                    g = 1 * (u - A.dimensions(t)[n] / 2) / p[n],
        ...
        J = function() {
            function t(t) {
                ...
                this.options = T({}, e, t), this.options.trigger_position.match(/^(bottom|top)-(left|right)$/) || (this.options.trigger_position = e.trigger_position), this.widgets = [], F.touch || v(), f()
            }
            return t.icon_images = {
                ...
                post_idea: "//widget.uservoice.com/omnibox/icons/lightbulb_bubble_icon.png",
                ...
                if (F.ie8) {
                    ...
                    s += "?trigger_color=" + encodeURIComponent(this.options.trigger_color), s += "&trigger_background_color=" + encodeURIComponent(this.options.trigger_background_color), s += "&icon_version=3", i = "<img src='" + s + "'/>"
                }
                this.el.innerHTML = i, F.ie8 || (this.options.trigger_color && (A(this.el, "path", "uv-bubble-foreground").style.fill = this.options.trigger_color), this.options.trigger_background_color && (A(this.el, "path", "uv-bubble-background").style.fill = this.options.trigger_background_color)), A.on(this.el, "click", function() {
                    e.visibleWidget ? e.visibleWidget.hide() : e.widget.show()
                }), F.touch || F.ie && !(F.ie && F.version > 9) || A.one(e.el, "mousemove", function() {
                    e.widget.preload()
                })
            }, t.prototype.createElement = function() {
                var t = this.el = e.createElement("div");
                t.setAttribute("data-html2canvas-ignore", !0), A.addClass(this.el, "uv-icon uv-" + this.options.trigger_position), F.ie8 && A.addClass(this.el, "uv-ie8"), e.body.appendChild(this.el)
        ...
        H = function() {
            function t(t, e) {
                this.el = t, this.options = e, A.data(this.el, "trigger", this)
            }
            return t.prototype.render = function() {
                var t = this;
                this.clickHandler = function(e) {
                    return t.options.trigger_prevent_default_enabled && e.preventDefault && e.preventDefault(), t.widget.toggle(), t.options.trigger_prevent_default_enabled ? !1 : void 0
                }, A.on(this.el, "click", this.clickHandler), F.touch || F.ie && !(F.ie && F.version > 9) || A.one(this.el, "mousemove", function() {
                    t.removed || t.widget.preload()
                })
            }, t.prototype.remove = function() {
                this.removed = !0, A.off(this.el, "click", this.clickHandler)
            }, t
        }(),
        $ = function() {
            function i(t, e, o) {
                this.options = T({
                    ...
                    width: "100%",
                    height: "100%"
                }, o), this.options.mode.match(/contact|instant/) ? this.options.mode = "contact" : "post_idea" === this.options.mode ? this.options.mode = "feedback" : "satisfaction" === this.options.mode && (this.options.survey_lockout = !1), this.pokes = [], this.loaded = !1, this.setLocation(), this.src = [this.location.baseUrl, this.queryString()].join("?"), this.sendUserData(), i.all.push(this)
            }
            return i.all = [], i.prototype.setLocation = function() {
                var t = "https";
                if (this.options.cdn) {
                    ...
                    this.location = {
                        host: e,
                        protocol: t,
                        baseUrl: t + "://" + e + "/" + this.options.type + "/" + UserVoice.account.client_key
                    }
                } else this.location = {
                ...
                this.loaded = !1, this.options.startIframeLoad = +new Date;
                ...
                if (t.attachEvent ? t.attachEvent("onload", function() {
                    ...
                    var r = t.onload;
                    t.onload = function() {
                        "function" == typeof r && r(), t.style.visibility = "visible"
                    }
                }
                return t.src = this.src, t
            }, i.prototype.queryString = function() {
                for (var e = {}, i = ["sso", "sess", "mode", "locale", "link_color", "topic_id", "forum_id", "article_id", "suggestion_id", "feedback_tab_name", "support_tab_name", "contact_us", "email", "status_ids", "smartvote_status_ids", "states", "category_ids", "smartvote_category_ids", "survey_lockout", "primary_color", "accent_color", "trigger_color", "trigger_background_color", "header", "border", "custom_template_id", "design_settings_id", "mixpanel_channel", "allow_tests", "demo", "startIframeLoad", "org_name", "post_idea_title", "contact_title", "smartvote_title", "context", "embed_type", "trigger_method", "menu", "screenshot_enabled", "mobile", "twitter_demo", "twitter_demo_username", "twitter_demo_message", "twitter_demo_satisfaction_thanks_mode", "twitter_demo_satisfaction_thanks_message", "permalinks_enabled", "instant_answers", "smartvote", "satisfaction", "contact_enabled", "feedback_enabled"], s = 0; s < i.length; s++) {
                    var r = i[s],
                        n = this.options[r];
                    n === o && (n = this.options["__" + r]), n !== o && ("string" == typeof n && r.match(/color/) && n.match(/^#/) && (n = n.substring(1)), "object" == typeof n && (n = JSON.stringify(n)), e[r] = n)
                }
                var a = this.options.ticket_custom_fields || this.options.custom_fields;
                return a && "object" == typeof a && (e.custom_fields = z(JSON.stringify(a))), e.smartvote_status_ids && (e.status_ids = e.smartvote_status_ids, delete e.smartvote_status_ids), e.smartvote_category_ids && (e.category_ids = e.smartvote_category_ids, delete e.smartvote_category_ids), this.options.menu_enabled !== o && (e.menu = this.options.menu_enabled), this.options.smartvote_enabled !== o && (e.smartvote = this.options.smartvote_enabled), this.options.satisfaction_enabled !== o && (e.satisfaction = this.options.satisfaction_enabled), this.options.post_idea_enabled !== o && (e.feedback_enabled = this.options.post_idea_enabled), "classic_widget" === this.options.type && (this.options.classic_default_mode !== o && (e.default_mode = this.options.classic_default_mode), e.mode = this.options.contact_enabled ? this.options.post_idea_enabled ? "full" : "support" : "feedback"), e.referrer = t.location.href, g(e, function(t) {
                    try {
        ...
        q = function() {
            function t(t, e) {
                var o = A.dimensions(t).height,
                    ...
                    r = new $("inline", s.widgetType, s),
                    n = t.currentStyle ? t.currentStyle.position : A.getComputedStyle(t, null).position;
                for ("static" === n && (t.style.position = "relative"); t.firstChild;) t.removeChild(t.firstChild);
                t.appendChild(r.render()), r.poke({
                    show: !0
                })
            }
            return t
        ...
        K = function() {
            ...
            return o.prototype.toggle = function() {
            ...
            }, o.prototype.preload = function() {}, o.prototype.hide = function() {
                this.iframe.poke("reset"), this.overlay && (this.overlay.style.display = "none"), A.removeClass(x(), "uvw-dialog-open")
                ...
                if (this.overlay || (b(D), this.overlay = h(c(this.template, this))), this.iframe.poke("opened"), !this.dialog || this.dialog.getAttribute("data-widget-key") !== this.id) {
                    ...
                    this.dialogContent.appendChild(this.iframe.el), this.dialog = e.getElementById(this.dialog_id), this.dialog.setAttribute("data-widget-key", this.id);
                    var t = this;
                    A.on(e.getElementById(this.dialog_close_id), "click", function() {
                        return t.hide()
                    })
                }
            }, o
        ...
        Q = function() {
            ...
            return i.setUvts = function(t) {
                i.uvts = t, $.sendUserData()
            }, i.setEmail = function(t) {
                i.email = t, $.sendUserData()
            }, i.addExternalUserId = function(t) {
                i.external_user_ids || (i.external_user_ids = []), i.external_user_ids.push(t), $.sendUserData()
            }, i.setSession = function() {
                i.session = !0, i.pendingAutoprompt && (i.pendingAutoprompt = !1, i.autoprompt())
            }, i.syncSession = function() {
                i.syncedSession = !0, i.pendingAutoprompt && (i.pendingAutoprompt = !1, i.autoprompt())
                ...
                if (F.mobile) return this.pendingAutoprompt = !1, void 0;
                if (this.systemTrigger && this.systemTrigger.el === o) return this.pendingAutoprompt = !0, void 0;
                var t = this.tracker.dumpSession(),
                    e = this.shouldShowSatisfactionPrompt(t),
                    s = this.shouldShowSmartVotePrompt(t);
                if (e || s) {
                    if (this.syncedSession === !1) return this.pendingAutoprompt = !0, this.tracker.syncSession(), void 0;
                    e && (i.recordAutoprompt("satisfaction"), this.tracker.updateSession({
                        ...
                        mode: "satisfaction"
                    }), this.tracker.track("autoprompt", {}, "satisfaction_widget")), s && (i.recordAutoprompt("smartvote"), this.tracker.updateSession({
                ...
                for (var r = 0; r < o.length; r++) {
                    var n = o[r];
                    t(n, "data-uv-inline", this.renderInline), t(n, "data-uv-embed", this.renderInline), t(n, "data-uv-lightbox", this.linkToLightbox), t(n, "data-uv-show", this.linkToPopover), t(n, "data-uv-trigger", this.linkToPopover)
                }
                ...
                return t.mode = t.mode || (t.contact_enabled ? "contact" : t.smartvote_enabled ? "smartvote" : "post_idea"), t.mode.match(/instant/) && (t.mode = "contact"), t.widgetType = "classic_widget" === t.mode ? t.mode : "omnibox", t
            }, i.active = null, i.hideActive = function() {
                ...
                return e && e.autoprompt && (i.autopromptOptions = T({
                    target: t
                }, Widget.autopromptOptions || {})), o.widget = s, o.render(), o
                ...
                if (!(F.ie && F.version < 8 && "icon" === o)) return s.push(r), s.render(), s
                ...
                return F.mobile && (s.mobile = !0), "lightbox" === s.target || "classic_widget" === s.mode ? new K(s, e) : s.target === !1 || "self" === s.target && !e ? (s.position = s.position || "bottom-right", new B(s, e)) : (s.position && s.position.match(/^(automatic|top|bottom|left|right)$/) || (s.position = "automatic"), F.mobile ? new B(s, e) : new R(s, e))
                ...
                n.type = "application/javascript", n.async = !0, n.defer = !0, n.src = "http://" + UserVoice.account.subdomain_ssl_host + "/clients/widgets/omnibox/autoprompts/create.json?" + g(s), r.parentNode.insertBefore(n, r)
                ...
                ratingSubmitted: function() {
                    i.systemTrigger && i.systemTrigger.pop(), i.tracker.updateSession({
                ...
                captureScreenshot: function(o, i, s) {
                    ("http://widget.uservoice.com" === s || "https://widget.uservoice.com" === s) && (t.html2canvas_onload_options = {
                        ...
                        t.type = "text/javascript", t.async = !0, t.src = "//cdn.uservoice.com" + UserVoice.manifest.screenshot + "?" + o;
    ...
    UserVoice.globalOptions = {}, UserVoice.push = function(t) {
        var e = t[0],
            o = t.slice(1);
        ...
        if ("object" == typeof t) UserVoice.globalOptions = m(UserVoice.globalOptions, t);
            ...
            var o = {};
            o[t] = e, UserVoice.set(o)
        }
    }, UserVoice.embed = function() {
        var t = arguments[0],
            e = arguments[1],
            s = arguments[2];
        return ("string" != typeof t || "#" === t[0]) && (e = arguments[0], s = arguments[1], t = null), e === o ? i("please specify where to embed it.") : (Q.renderInline(A.element(e), t, s), void 0)
        ...
        } else e = t || {}, Q.systemTrigger && Q.systemTrigger.remove(), Q.systemTrigger = Q.createSystemTrigger(_(e))
    }, UserVoice.show = function(t) {
        "string" == typeof arguments[0] && (t = T({
            mode: arguments[0]
        }, arguments[1] || {})), Q.showWidget(T({
            trigger_method: "show"
        }, t || {}))
        ...
        Q.autopromptOptions = t, Q.autoprompt()
    }, UserVoice.identify = function(t) {
        Q.tracker.identify(t), t && t.email && Q.setEmail(t.email)
    ...
    }, UserVoice.setOption = UserVoice.setOptions = UserVoice.set, UserVoice.setSSO = function(t) {
        UserVoice.set("sso", t)
    ...
    }, UserVoice.showPrompt = UserVoice.showPopover = UserVoice.show, UserVoice.showLightbox = function(t, e) {
        Q.showWidget(T({
            target: "lightbox"
        }, k(t, e)))
    }, UserVoice.hideLightbox = function() {}, UserVoice.showIcon = UserVoice.pin = function(t, e) {
        e && (e.trigger_position = e.position, e.position = "automatic"), UserVoice.addTrigger(T({
            mode: t,
            trigger_style: "icon"
        }, e || {}))
